...
describe("EndpointDiagnostics", () => {
  it("renders one row per service in mock mode with disabled probe", () => {
    ...
    // 18 service rows (incl. reference-data / geometry /
    // scheduling-integration / traffic-control added в T10).
    expect(
    ...
    expect(checkBtns).toHaveLength(18);
  ...
  it("shows configured/default badges in live mode and enables probe", () => {
    ...
    // One configured override, ten defaults. The column header
